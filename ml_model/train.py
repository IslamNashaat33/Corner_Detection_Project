"""
Training script for the corner detection model.
"""
import os
import sys
...
from ml_model.data_loader import load_dataset, get_dataset_info
from ml_model.feature_engineering import extract_features_batch, FEATURE_NAMES
